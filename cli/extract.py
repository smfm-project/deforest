...
def main(source_files, target_extent, resolution, EPSG_code, training_data, forest_values, nonforest_values, field_name = '', n_processes = 1, max_images = 0, max_pixels = 5000, output_dir = os.getcwd(), output_name = 'S2'):
    ...
    forest_px, nonforest_px =  deforest.extraction.extractData(scenes, training_data, md_dest, forest_values, nonforest_values, field = field_name, subset = max_pixels, n_processes, output = True, output_dir = output_dir, output_name = output_name)
...
if __name__ == '__main__':
    ...
    # Execute script
    main(args.infiles, args.target_extent, args.resolution, args.epsg, args.training_data, args.forest_values, args.nonforest_values, field_name = args.field_name, n_processes = args.n_processes, max_pixels = args.max_pixels, output_dir = args.output_dir, output_name = args.output_name)
